...
const COOKIE_DATA = [
  {
    ...
    price: 6.5,
    image: `${import.meta.env.BASE_URL}img/pistachio.jpg`,
  },
  {
    id: "2",
    ...
    price: 6.5,
    image: `${import.meta.env.BASE_URL}img/kinderbueno.png`,
  },
  {
    id: "3",
    ...
    price: 6.5,
    image: `${import.meta.env.BASE_URL}img/biscoff.jpg`,
  },
  {
    id: "4",
    ...
    price: 6.5,
    image: `${import.meta.env.BASE_URL}img/nutella.png`,
  },
  {
    id: "5",
    ...
    price: 6.5,
    image: `${import.meta.env.BASE_URL}img/cac.png`,
  },
];
...
const INITIAL_MESSAGES = [
  ...
  },
  {
    id: 2,
    from: "support",
    text: "I can help with pre-order questions like flavours, prices, payment, collection, delivery, allergens, and storage.",
  },
];
...
export default function App() {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      const response = await fetch("https://crispyharvest-backend.onrender.com", {
        method: "POST",
        headers: {
  ...
  const addDraftToCart = (item) => {
    ...
    if (draftQty === 0) {          // ← new guard
      alert("Please select a quantity before adding to your order.");
      return;
    }

    const requestedQty = draftQty;  // ← now always a real user-chosen value
    ...
    <section className="screen-container messages-screen">
      <header className="chat-header">
        ...
        <div>
          ...
          <p>● Pre-order help — replies instantly</p>
        </div>
      </header>
